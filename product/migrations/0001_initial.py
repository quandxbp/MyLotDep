# Generated by Django 2.2.5 on 2019-10-17 09:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(choices=[('tiki', 'Tiki'), ('lazada', 'Lazada'), ('adayroi', 'Adayroi')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(default='images/%Y/%m/%D/no-img.jpg', upload_to='images/%Y/%m/%D/')),
                ('price', models.DecimalField(decimal_places=4, default=Decimal('0.0000'), max_digits=20)),
                ('list_price', models.DecimalField(decimal_places=4, default=Decimal('0.0000'), max_digits=20)),
                ('discount', models.DecimalField(decimal_places=4, default=Decimal('0.0000'), max_digits=20)),
